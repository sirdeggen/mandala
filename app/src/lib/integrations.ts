...
export const PROVIDERS: Provider[] = [
  ...
  { id: 'ofac', name: 'OFAC (US Treasury)', category: 'sanctions', authType: 'webhook', monogram: 'OF', color: '#0a3161', domain: 'treasury.gov', subsystem: 'screening', powers: 'US SDN & consolidated sanctions lists', blurb: 'Direct OFAC SDN and consolidated list ingestion.', scopes: ['lists.read'] },
  { id: 'eu-sanctions', name: 'EU Consolidated (EEAS)', category: 'sanctions', authType: 'webhook', monogram: 'EU', color: '#003399', domain: 'europa.eu', subsystem: 'screening', powers: 'EU consolidated financial sanctions', blurb: 'EU consolidated sanctions list feed.', scopes: ['lists.read'] },
  { id: 'un-sanctions', name: 'UN Security Council', category: 'sanctions', authType: 'webhook', monogram: 'UN', color: '#5b92e5', domain: 'un.org', subsystem: 'screening', powers: 'UN consolidated sanctions list', blurb: 'UN Security Council consolidated list feed.', scopes: ['lists.read'] },
  { id: 'uk-ofsi', name: 'UK OFSI', category: 'sanctions', authType: 'webhook', monogram: 'UK', color: '#1d70b8', domain: 'gov.uk', subsystem: 'screening', powers: 'UK financial sanctions targets', blurb: 'HM Treasury OFSI consolidated list feed.', scopes: ['lists.read'] },
  { id: 'ch-seco', name: 'Swiss SECO (SESAM)', category: 'sanctions', authType: 'webhook', monogram: 'CH', color: '#d52b1e', domain: 'seco.admin.ch', subsystem: 'screening', powers: 'Swiss sanctions programme', blurb: 'SECO sanctions feed (SESAM).', scopes: ['lists.read'] },
